...
import com.example.taron.projecttwokeyvalue.sp.CallBackFromFragment;
...
public class AddKeyValueDialogFragment extends DialogFragment {
    ...
    private CallBackFromFragment backFromFragment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        final List<ModelForKeyValue> refreshList = ((MainActivity) getActivity()).getList();
         backFromFragment = (CallBackFromFragment) getActivity();
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!key.isEmpty() && !value.isEmpty()) {
                    ...
                    backFromFragment.callBackForActivity();
                    dismiss();
                } else {
